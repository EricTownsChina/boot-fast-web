...
/**
 * FROM https://github.com/yangguang010/DateUtil.git
 *
 * @author yangguang010
 ...
 *       年（yyyy）
 *       年月（yyyyMM、yyyy-MM）
 *       年月日（yyyyMMdd、yyyy-MM-dd）
 *       年月日时分（yyyyMMddHHmm、yyyy-MM-dd HH:mm）、
 *       年月日时分秒（yyyyMMddHHMISS、yyyy-MM-dd HH:MI:SS）等
 *
 *   方法包括:
 *       1. 根据Date时间，转化成上面各种日期格式；
 *       2. 解析两个日期之间的所有月份
 *       3. 解析两个日期之间的所有日期
 *       4. 获取当下年份指定前后数量的年份集合
 *       5. 获取当前日期是一年中的第几周
...
public class DateUtil {
     ...
     */
    public static final String DATE_FORMAT_POINT_YYYY_MM_DD = "yyyy.MM.dd";

    /**
     * 日期格式，年月日，例如：2016年10月05日
     */
    public static final String DATE_TIME_FORMAT_CHINESE_YYYY_MM_DD = "yyyy年MM月dd日";
